...
public class OneFragment extends Fragment{
    ...
    static Gallery.FirstPageFragmentListener firstPageFragmentListener1;


    public static OneFragment newInstance(Gallery.FirstPageFragmentListener firstPageFragmentListener) {
